...
#4
Let's improve the UX, make this app shine a little bit. We now have the loading icon in the middle, let's make text
appear under it, changing every 4 seconds to rotate through an array of loading captions, such as:
"Scouring the web.."
"Consulting applicants' advice.."
"Compiling sources.."
"Reviewing your resume.."
These strings can easily be added to, but these 4 will do for now. They should be the same orange color as the loading
icon, and the size of the text should be 12 pt.
